...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.acec8a458828f93f81cf74da044becdc4a2f98cc562075c3eb5e4f554d4f41e4.js',function(){input.required=false;search();});}
